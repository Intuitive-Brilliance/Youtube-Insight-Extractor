...
@app.route('/overview',methods=['POST','GET']) # route to show the review comments in a web UI
@cross_origin()
def index():
...
@app.route('/insights',methods=['POST','GET']) # route to show the review comments in a web UI
@cross_origin()
def insights():
    if request.method == 'POST':
        try:
...
@app.route('/savetocloud',methods=['POST','GET']) # route to show the review comments in a web UI
@cross_origin()
def savetocloud():
    if request.method == 'POST':
        try:
